...
## Retrieves the layer and index of a hand landmark
...
##Computes the relative distance between two points.
def GetRelativeDistance(StandardLength, p1, p2):
    PointDistance = GetPointsDistance(p1, p2)
    return PointDistance / StandardLength


##Processes the image using Mediapipe to extract hand landmarks and computes relative distances between them.
