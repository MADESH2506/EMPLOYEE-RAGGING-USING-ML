...
if __name__ == '__main__':
    ...
    while cap.isOpened():
        ...
        try:
            ...
            if SpelledWord == 'COUNSELLING':
                subject = "Seeking Support for Emotional Issues"
                body = "I'm reaching out for support regarding recent emotional challenges. Your assistance and guidance would be greatly appreciated."
                send_email(image, subject, body)

            elif SpelledWord == 'Emergency Call - ':
                subject = "Urgent:  Emergency"
                body = "This is an emergency call regarding a  incident. Immediate action and intervention are required."
                send_email(image, subject, body)

            elif SpelledWord == 'MEDICATION SUPPORT':
                subject = "Seeking Medication Support"
                body = "I am in need of medication support and would appreciate your assistance in this matter."
                send_email(image, subject, body)
